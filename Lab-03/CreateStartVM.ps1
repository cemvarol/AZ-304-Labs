...
$Gurl = "https://raw.githubusercontent.com/cemvarol/AZ-304-Labs/master/Lab-03/GuestVM.ps1"
$Goutput = ".\GuestVM.ps1"
Invoke-WebRequest -Uri $Gurl -OutFile $Goutput

$GBurl = "https://raw.githubusercontent.com/cemvarol/AZ-304-Labs/master/Lab-03/GuestBat.bat"
