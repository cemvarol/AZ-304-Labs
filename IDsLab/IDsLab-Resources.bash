az group create --name IDLab1 --location 'EastUs'
az group create --name IDLab2 --location 'EastUs'
...
az storage account create --name $D --resource-group IDLab1 --kind Storage --location EastUs --sku Standard_LRS
