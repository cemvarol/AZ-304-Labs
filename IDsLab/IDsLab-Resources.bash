...
az vm create --resource-group IDLab1 --name IDs-VM01 --location $L --image MicrosoftWindowsServer:WindowsServer:2019-Datacenter-Core:17763.1039.2002091844 --admin-username cem --admin-password 1q2w3e4r5t6y* --size standard_D4s_v3 --public-ip-address "IDs-VM01-Pip" --subnet $SUBNETID --boot-diagnostics-storage $D --license-type Windows_Server --nsg "" --no-wait
